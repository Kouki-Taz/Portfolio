...
public class ObservationCamera : MonoBehaviour
{
    ...
    public float maxCameraAngleX = 75.0f; // カメラの最大角度
    ...
    void Update()
    {
        ...
        else if (Input.touchCount == 2)
        {
            ...
            if (Input.touches[0].phase == TouchPhase.Ended || Input.touches[1].phase == TouchPhase.Ended){
                ...
                float pinchZoomDistance = (basePinchDistance - currentPinchDistance) * pinchZoomSpeed * 0.005f * (-1);
        ...
        if (isMouseDown){
            ...
            float angleX = this.transform.eulerAngles.x - distanceMousePos.y * swipeTurnSpeed * 0.008f * (-1);
            float angleY = this.transform.eulerAngles.y + distanceMousePos.x * swipeTurnSpeed * 0.008f;
